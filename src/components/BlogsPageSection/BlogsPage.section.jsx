  ...
  const [blogs] = useState([
    {
      ...
      title: 'Lorum Ipsum',
      desc:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vulputate proin mattis enim quis venenatis sit turpis sed. Mattis et nulla augue phasellus.',
  ...
  return (
    <section className="ml-16 text-center my-4 absolute">
      ...
      <div className="flex flex-row justify-center flex-wrap">
        {blogs.map(blogs => (
          <BlogsNet key={blogs.id} desc={blogs.desc} image={blogs.image}>
            {blogs.title}
          </BlogsNet>
        ))}
      </div>
      <div className="relative">
        <div
          className="w-8 h-8 blogspage-medium-image top-0 right-0 absolute"
          style={imageStyle1}
        />
        <div
          className="w-4 h-3 blogspage-vector-image top-0 right-0 absolute"
          style={imageStyle2}
        />
